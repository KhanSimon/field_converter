#!/bin/bash -l
#SBATCH --job-name=evaluate_root_mlp
...
PYTHONPATH=src python -m field_converter.training.evaluate_root_mlp --config configs/mlp/root_mlp_v1_train.yaml --checkpoint best
