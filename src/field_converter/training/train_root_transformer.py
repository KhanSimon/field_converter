...
from field_converter.training.tcn.trainer import train_temporal_root
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train V1 temporal root Transformer")
